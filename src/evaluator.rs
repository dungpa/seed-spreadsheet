...
// fn create_binary((expr1, operator, expr2): (&Expr, &str, &Expr)) -> Expr {
//     let op = operator.chars().nth(0).unwrap();
...
//     map(tuple(parse_term, delimited(space0, parse_operator, space0), parse_term), create_binary)(input)
// }
