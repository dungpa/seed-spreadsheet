...
fn evaluate(visited: &mut HashSet<Position>, cells: &HashMap<Position, String>, expr: Expr) -> Option<i32> { 
  match expr {
...
pub fn run (value: &str, cells: &HashMap<Position, String>) -> Option<i32> {
